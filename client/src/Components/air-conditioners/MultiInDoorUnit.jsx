...
const MultiIndoorUnit = () => {
  ...
  const getMultiIndoorUnit = async () => {
    ...
    setError(null);
    try {
      const res = await axios.get(`http://localhost:8000/api/air-conditioner/multiIndoorUnit/multiIndoorUnit/${productId}`);
      if (res.status !== 200) {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* Stepper for Features */}
      <div style={styles.stepperContainer}>
        <Stepper style={{ direction: 'rtl' }} activeIndex={0}>
          <StepperPanel header="מאפיינים טכניים">
...
export default MultiIndoorUnit;